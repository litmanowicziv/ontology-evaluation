...
from evaluation.ontology.sparql import get_superclasses_of_concept, get_subclasses_of_concept, get_relations
from evaluation.structs import Concept, Relation, ConceptFamily
